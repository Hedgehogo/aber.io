...
The entire document is a *block*.
## Comment
...
A *statement* is an *expression* or *assignment*.
...
## Block
A *block* is a sequence containing sequentially: the *character* `{` or the beginning of the document , *whitespace*, any number of sequences I separated by the sequence S, the *character* `{` or the end of the document. The content is the sequence of *expressions* contained in the sequence I.

The sequence I starts with a *statement* and ends with *whitespace*.
