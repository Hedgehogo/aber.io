...
## Expression
A *meaningful syntactic unit* is any of the listed syntactic units: *number*, *char*, *string*, *pair*, *tuple*, *block*, *generic arguments*, *call*, *method call*, *child call* and *negative call*.
...
## Block
A *block* is a sequence containing sequentially: the *character* `{`, *whitespace*, any number of *statements*, *expression*, *whitespace*, the *character* `}`. The contents are the contents of a sequence of *statements* and an *expression*.
...
- It must not begin with the *character* `-` followed by a *decimal digit*.
