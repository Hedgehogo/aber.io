An *object* has one [*type*](Specification/Compilation/Type_system/Constraint/Type/_.md). An *object* has a *lifetime*.
...
Syntactically, [*call syntax*](Specification/Compilation/Order/Syntax/_.md#call) is considered an *object* obtained by substituting *generic arguments* into *generic parameters*. 
