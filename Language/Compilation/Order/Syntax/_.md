...
| Operаtor                | Priority | Notation | Associativity |
| ----------------------- | -------- | -------- | ------------- |
| *Method call*           | 1        | Postfix  | -             |
| *Associated call*       | 1        | Postfix  | -             |
| *Initialization*        | 1        | Postfix  | -             |
| *Negative call*         | 2        | Prefix   | -             |
| *Negative generic list* | 2        | Prefix   | -             |
| *Whitespace*            | 3        | Infix    | Associative   |
...
## Generic list
A *generic list* is a sequence containing sequentially: 
- the *character* `[`
- any number of sequences I separated by the sequence S
- the optional sequence S
- *whitespace*
...
The sequence G starts with *whitespace* and ends with *generic list*.
...
## Super call
A *super call* is a sequence containing sequentially: the sequence `'::`, *whitespace*, *call*.
...
## Crate call
A *crate call* is a sequence containing sequentially: the sequence `''::`, *whitespace*, *call*.
...
The sequence F contains sequentially: *whitespace*, the character `.`, *identifier*, *whitespace* and the character `=`. The content is *identifier*.
...
## Negative generic list
A *negative generic list* is a sequence containing sequentially: 
- the sequence `@[`
- any number of sequences I separated by the sequence S
- the optional sequence S
- *whitespace*
...
It has higher priority than a *method call*, a *child call* or an *initialization*.

The contents of this *expression* and the sequence of the contents of the sequences I.

The sequence I starts with *identifier*, continues with *whitespace*, and ends with optional sequence F. The contents are the *identifier* and the optional contents of sequence F.

The sequence F contains sequentially: the character `:`, *whitespace*, *expression* and *whitespace*. The content is *expression*.
