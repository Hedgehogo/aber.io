...
**Raw string**
Starts with N number of characters `"` and ↵ (Newline). Each following line starts with the sequence W followed by a sequence С of any characters. The last line contains the sequence W followed by N number of characters `"`.

The concatenation of all C sequences is the contents of the string.

The number of N must be at least 3.
