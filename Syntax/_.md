...
## Parameters
A *parameters* is a sequence containing sequentially: the *character* `[`, *whitespace*, any number of sequences I separated by the sequence S, the optional sequence S, the *character* `]`. The content is the sequence of *expressions* contained in the sequence I.
...
## Сall
A *call* is a sequence starting with an *identifier* and ending with optional *parameters*.
